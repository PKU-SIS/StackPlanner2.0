    ...
    onCustomEvent(event: unknown) {
      if (
        ...
        updateSubtask({
          id: e.task_id,
          status: "in_progress",
          subagent_type: e.subagent_type ?? "subagent",
          description: e.description ?? "Delegated task",
          prompt: e.prompt ?? e.description ?? "",
        });
        return;
      }
      ...
      if (
        ...
        updateSubtask({
          id: e.task_id,
          status: e.type === "task_completed" ? "completed" : "failed",
          result: e.result,
          error: e.error,
